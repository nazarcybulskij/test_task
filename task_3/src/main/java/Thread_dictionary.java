...
public class Thread_dictionary extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            File dictionary;
            try (BufferedReader reader_console = new BufferedReader(new InputStreamReader(System.in))) {
                input_word = reader_console.readLine();
                dictionary = new File(reader_console.readLine());
            }

            try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(dictionary.getAbsoluteFile())))) {
